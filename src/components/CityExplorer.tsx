...
export const cities: City[] = [
  ...
  { name: "Rishikesh", country: "India", region: "india", image: "https://images.unsplash.com/photo-1545652985-6e4eaca3d275?w=400&h=300&fit=crop", budget: "₹2,000/day", budgetPerDay: 2000, bestTime: "Sep - Nov", rating: 4.5, highlights: ["River Rafting", "Yoga Ashrams", "Ram Jhula"], description: "Yoga capital of the world — adventure sports meet spiritual serenity by the Ganges.", avgTemp: "22°C", travelersPerYear: "2.5M" },
  { name: "Darjeeling", country: "India", region: "india", image: "https://images.unsplash.com/photo-1622308644420-f7aadc402e96?w=400&h=300&fit=crop", budget: "₹2,800/day", budgetPerDay: 2800, bestTime: "Mar - May", rating: 4.4, highlights: ["Tiger Hill", "Tea Plantations", "Toy Train"], description: "Queen of the Hills — misty tea gardens with Himalayan panoramas.", avgTemp: "15°C", travelersPerYear: "1.5M" },
  // World
