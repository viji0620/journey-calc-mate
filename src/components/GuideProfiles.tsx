...
import { Star, MapPin, Languages, Calendar, Award, Heart, MessageSquare, X } from "lucide-react";
...
const guides: Guide[] = [
  {
    id: "1", name: "Rahul Sharma", photo: guideRahul, location: "Jaipur, Rajasthan",
    speciality: "Heritage & Culture", languages: ["Hindi", "English", "French"],
    rating: 4.9, reviews: 342, experience: "12 years", pricePerDay: "₹3,500",
    bio: "Born and raised in Jaipur, Rahul brings the Pink City alive with stories of Rajput valor, hidden palace passages, and the best lassi spots locals don't share.",
    highlights: ["Certified heritage guide", "Photography walks", "Royal cuisine tours"],
  },
  {
    id: "2", name: "Priya Nair", photo: guidePriya, location: "Kerala Backwaters",
    speciality: "Nature & Ayurveda", languages: ["Malayalam", "English", "Tamil"],
    rating: 4.8, reviews: 218, experience: "8 years", pricePerDay: "₹3,000",
    bio: "An Ayurveda practitioner turned guide, Priya combines backwater houseboat journeys with authentic wellness experiences across God's Own Country.",
    highlights: ["Houseboat tours", "Spice plantation walks", "Ayurveda sessions"],
  },
  {
    id: "3", name: "Kenji Tanaka", photo: guideKenji, location: "Tokyo, Japan",
    speciality: "Culture & Food", languages: ["Japanese", "English"],
    rating: 4.9, reviews: 456, experience: "15 years", pricePerDay: "$150",
    bio: "A food photographer who became a guide, Kenji takes you beyond tourist Tokyo into hidden ramen alleys, sake bars, and sunrise temple visits.",
    highlights: ["Street food tours", "Temple dawn walks", "Anime district guides"],
  },
  {
    id: "4", name: "Emma Laurent", photo: guideEmma, location: "Paris, France",
    speciality: "Art & History", languages: ["French", "English", "Italian"],
    rating: 4.7, reviews: 289, experience: "10 years", pricePerDay: "€180",
    bio: "An art historian with a passion for storytelling, Emma reveals Paris through its hidden courtyards, bohemian cafés, and lesser-known masterpieces.",
    highlights: ["Louvre skip-the-line", "Montmartre art walks", "Wine & cheese tours"],
  },
  {
    id: "5", name: "Omar Al-Rashid", photo: guideOmar, location: "Dubai, UAE",
    speciality: "Luxury & Adventure", languages: ["Arabic", "English", "Urdu"],
    rating: 4.8, reviews: 187, experience: "7 years", pricePerDay: "$200",
    bio: "From desert dune bashing to yacht brunches, Omar crafts unforgettable Dubai experiences that blend Bedouin traditions with modern luxury.",
    highlights: ["Desert camping", "Yacht tours", "Gold souk experiences"],
  },
  {
    id: "6", name: "Nina Srisai", photo: guideNina, location: "Bangkok, Thailand",
    speciality: "Street Food & Temples", languages: ["Thai", "English", "Mandarin"],
    rating: 4.6, reviews: 312, experience: "9 years", pricePerDay: "$80",
    bio: "Nina knows every street vendor and hidden temple in Bangkok. Her tours are a sensory overload of flavors, colors, and stories.",
    highlights: ["Night market tours", "Temple hopping", "Thai cooking classes"],
  },
];
...
const GuideProfiles = () => {
  ...
  const handleBook = () => {
    if (!bookingDate || !bookingName || !bookingEmail) {
      toast({ title: "Please fill all fields", variant: "destructive" });
      return;
    }
    toast({
      title: "Booking Request Sent! 🎉",
      description: `Your booking with ${bookingGuide?.name} for ${bookingDate} has been submitted. We'll confirm via email.`,
    });
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      variant="outline"
                      className="text-xs font-body rounded-full"
                    ...
                    <Button
                      size="sm"
                      className="text-xs font-body rounded-full gradient-accent text-accent-foreground"
            ...
            >
              ...
              >
                <div className="relative">
                  ...
                  <button onClick={() => setSelectedGuide(null)} className="absolute top-3 right-3 w-8 h-8 rounded-full bg-card/80 flex items-center justify-center">
                    <X className="w-4 h-4" />
                  </button>
                </div>
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-border">
                    ...
                    <Button
                      className="gradient-accent text-accent-foreground rounded-full font-body"
                      onClick={() => { setSelectedGuide(null); setBookingGuide(selectedGuide); }}
                    >
                      Book This Guide
                    </Button>
                  </div>
            ...
            >
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button onClick={() => setBookingGuide(null)} className="w-8 h-8 rounded-full bg-secondary flex items-center justify-center">
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input value={bookingName} onChange={(e) => setBookingName(e.target.value)} placeholder="John Doe" className="font-body" />
                  </div>
                  <div>
                    <label className="text-xs font-body text-muted-foreground mb-1 block">Email</label>
                    <Input value={bookingEmail} onChange={(e) => setBookingEmail(e.target.value)} placeholder="john@example.com" type="email" className="font-body" />
                  </div>
                  <div>
                    <label className="text-xs font-body text-muted-foreground mb-1 block">Preferred Date</label>
                    <Input value={bookingDate} onChange={(e) => setBookingDate(e.target.value)} type="date" className="font-body" />
                  </div>
